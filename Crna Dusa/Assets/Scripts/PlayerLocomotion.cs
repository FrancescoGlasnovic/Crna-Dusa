...
namespace crna
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        {
            if (animtorHandler.anim.GetBool("isInteracting"))
            {
                return;
            }
            if (inputHandler.rollFlag)
            {
                ...
                {
                    animtorHandler.PlayTargetAnimation("Rolling", true);
                    moveDirection.y = 0;
                ...
                {
                    animtorHandler.PlayTargetAnimation("Backstep", true);
                }
            }
        }
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            if (Physics.Raycast(origin, -Vector3.up, out hit, minimumDistanceNeededToBeginFall, ignoreForGroundCheck))
            {
                ...
                if (playerManager.isInAir)
                {
                    if (inAirTimer > 0.5f)
                    {
                        ...
                        animtorHandler.PlayTargetAnimation("Land", true);
                        inAirTimer = 0;
                    }
                    else
                    {
            ...
            else
            {
                ...
                if (playerManager.isInAir == false)
                {
                    ...
                    {
                        animtorHandler.PlayTargetAnimation("Falling", true);
                    }
